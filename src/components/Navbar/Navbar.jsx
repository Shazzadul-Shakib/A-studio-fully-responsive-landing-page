        ...
        <ul className=' hidden md:flex text-[#000000] sm:text-sm lg:text-base'>
          ...
          <div className={`${toggle? 'visible': 'hidden'} md:hidden bg-[#2639ED] justify-center py-6 rounded-l-xl right-0 top-16 absolute min-w-[140px]`} >
            <ul className=' text-white my-2 '>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">Home</a></li>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">What We Do</a></li>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">Service</a></li>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">Project</a></li>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">Blog</a></li>
              <li className=' ml-10 my-4 hover:text-orange-600'><a href="#">Contact</a></li>
            </ul>
          </div>
