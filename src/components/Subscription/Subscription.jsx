...
const Subscription = () => {
  return (
    <div
      className=' h-[387px] w-full mx-6 grid grid-cols-1 content-evenly items-center lg:grid-cols-2   '
    ...
    >
      ...
      <div className=' flex justify-center items-center '>
        <div class=" flex ">
            <div class="relative">
                <input type="text" class="h-14  sm:w-[480px] pl-10 pr-20  focus:shadow focus:outline-none drop-shadow-2xl rounded-full" placeholder="Enter your email address..."/>
