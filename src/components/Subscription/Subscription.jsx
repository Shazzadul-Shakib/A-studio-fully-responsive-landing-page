...
const Subscription = () => {
  return (
    <div
      className=' h-[387px] w-full flex justify-center items-center '
    ...
    >
      ...
      <div className=' flex '>
        <div class=" flex ">
            <div class="relative">
                <input type="text" class="h-14  lg:w-[480px] pl-10 pr-20  z-0 focus:shadow focus:outline-none drop-shadow-2xl rounded-full" placeholder="Enter your email address..."/>
